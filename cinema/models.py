...
class VentaConfiteria(models.Model):
...
class DetalleVentaConfiteria(models.Model):
    venta = models.ForeignKey(VentaConfiteria, related_name="detalles", on_delete=models.CASCADE)
...
class CompraCombo(models.Model):

    usuario = models.ForeignKey(
        User,
        on_delete=models.CASCADE,
        related_name='compras_combos'
    )
